...
void send_5d_no_chunk(int* source, int other_rank, int* current_size, int* from, int* to, MPI_Request *request, int* buffer) {
    int SUB_NI = to[0] - from[0];
    int SUB_NJ = to[1] - from[1];
    int SUB_NK = to[2] - from[2];
    int SUB_NL = to[3] - from[3];
...
void recv_5d_no_chunk(int* target, int other_rank, int* new_size, int* from, int* to) {
    int SUB_NI = to[0] - from[0];
    int SUB_NJ = to[1] - from[1];
    int SUB_NK = to[2] - from[2];
    int SUB_NL = to[3] - from[3];
