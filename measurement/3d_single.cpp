...
int main(int argc, char** argv){
    ...
    constexpr int CHUNK_SIZE = SUB_NI*SUB_NJ*SUB_NK; // send all at once (same as no chunk)
    ...
    NdIndices<N> chunk_num = {CHUNK_I, CHUNK_J, CHUNK_J};
    NdIndices<N> current_size = {NI, NJ, NK};
    NdIndices<N> new_size = {NI_NEW, NJ_NEW, NK_NEW};
    NdIndices<N> from = {FROM_I, FROM_J, FROM_K};
    NdIndices<N> to = {TO_I, TO_J, TO_K};
    ...
    int send_array_size[N] = {NI,NJ,NK};
    int send_start[N] = {FROM_I,FROM_J,FROM_K};
    int recv_array_size[N] = {NI_NEW,NJ_NEW,NK_NEW};
    int recv_start[N] = {FROM_I_NEW,FROM_J_NEW,FROM_K_NEW};
    ...
    send_array = new T[SUB_NI*SUB_NJ*SUB_NK];
    recv_array = new T[SUB_NI*SUB_NJ*SUB_NK];
